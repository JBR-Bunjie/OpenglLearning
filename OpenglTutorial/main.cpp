...
glm::vec3 camInitPos = glm::vec3(0.3f, 0.5f, 3.0f);
glm::vec3 worldInitUp = glm::vec3(0.0f, 1.0f, 0.0f);
Camera camera = Camera::Camera(camInitPos, -15.0f, 180.0f, worldInitUp);
#pragma endregion
...
#pragma region Init Light
    ...
    glm::vec3 lightPos(0, 0, 1.0f);
    glm::vec3 lightAmbient(ambientColor.x, ambientColor.y, ambientColor.z);
    glm::vec3 lightDiffuse(diffuseColor.x, diffuseColor.y, diffuseColor.z);
...
#pragma region Init Lights
    LightDirectional lightDirectional = LightDirectional::LightDirectional(
...
#pragma endregion
    ...
    // register the call_back function
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            // Set viewpoint Pos (use Camera Pos)
            ...
            // glm::vec3 diffuseColor = lightColor * glm::vec3(0.5f);
            // glm::vec3 ambientColor = diffuseColor * glm::vec3(0.2f);
            // lightDirectional.updateColor(lightAmbient, lightDiffuse, lightSpecular);
            lightDirectional.setProgram(objectShader.Program, lightName.c_str());
            lightDirectional.applyLightProperties();
